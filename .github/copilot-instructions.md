...
1. **`.github/IDEAS.md`** — All project ideas and future plans (3 phases, task backlog)
...
## Current Task Backlog (Phase 3)

From IDEAS.md — each task is an independent feature:

| Task | Status | Summary |
|------|--------|---------|
| TASK-001 | Pending | Switch to PostgreSQL on Railway |
| TASK-002 | Pending | Backup/restore production DB |
| TASK-003 | Pending | Modify stats with incremental values (`+2`, `-4`, `=13`) |
| TASK-004 | Pending | `/character post` — post sheet to chat |
| TASK-005 | Pending | Combat Scores — hit die, class/race defaults, reformatted display |
